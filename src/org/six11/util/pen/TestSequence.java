...
//     ret.add(new Pt(3.0, 1.8));
  ...
  public void testNormalize() {
    ...
    for (int i=0; i < 10; i++) xsquared.add(f(i));
  ...
  public void testGetSpline() {
    ...
    bug("There are " + spline.size() + " points in the spline, and " + base.size() + " points in the orignal sequence");
      for (Pt pt : spline) {
	//	System.out.println(pt.getX() + "\t" + pt.getY()); // I can look at this in JMP or something
      }
  }
